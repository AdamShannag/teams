...
type UserQuery struct {
	...
	withUser     *UserQuery
	withApproved *UserQuery
	withApprove  *UserQuery
...
func (uq *UserQuery) QueryTeam() *TeamQuery {
...
func (uq *UserQuery) QueryAssigned() *UserQuery {
...
func (uq *UserQuery) QueryUser() *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) QueryApproved() *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) QueryApprove() *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withAssigned: uq.withAssigned.Clone(),
		withUser:     uq.withUser.Clone(),
		withApproved: uq.withApproved.Clone(),
		withApprove:  uq.withApprove.Clone(),
...
func (uq *UserQuery) WithTeam(opts ...func(*TeamQuery)) *UserQuery {
	query := (&TeamClient{config: uq.config}).Query()
...
func (uq *UserQuery) WithAssigned(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withAssigned = query
	return uq
}

// WithUser tells the query-builder to eager-load the nodes that are connected to
// the "user" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithUser(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) WithApproved(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withApproved = query
	return uq
}
...
func (uq *UserQuery) WithApprove(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withApprove = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withTeam; query != nil {
		if err := uq.loadTeam(ctx, query, nodes,
			func(n *User) { n.Edges.Team = []*Team{} },
			func(n *User, e *Team) { n.Edges.Team = append(n.Edges.Team, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withTeams; query != nil {
		if err := uq.loadTeams(ctx, query, nodes, nil,
			func(n *User, e *Team) { n.Edges.Teams = e }); err != nil {
			return nil, err
		}
	}
	if query := uq.withAssigned; query != nil {
		if err := uq.loadAssigned(ctx, query, nodes, nil,
			func(n *User, e *User) { n.Edges.Assigned = e }); err != nil {
			return nil, err
		}
	}
	if query := uq.withUser; query != nil {
		if err := uq.loadUser(ctx, query, nodes,
			func(n *User) { n.Edges.User = []*User{} },
			func(n *User, e *User) { n.Edges.User = append(n.Edges.User, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withApproved; query != nil {
		if err := uq.loadApproved(ctx, query, nodes, nil,
			func(n *User, e *User) { n.Edges.Approved = e }); err != nil {
			return nil, err
		}
	}
	if query := uq.withApprove; query != nil {
		if err := uq.loadApprove(ctx, query, nodes,
			func(n *User) { n.Edges.Approve = []*User{} },
			func(n *User, e *User) { n.Edges.Approve = append(n.Edges.Approve, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*User, init func(*User), assign func(*User, *Team)) error {
...
func (uq *UserQuery) loadAssigned(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
...
func (uq *UserQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(user.FieldAssignedBy)
	}
...
func (uq *UserQuery) loadApproved(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
...
func (uq *UserQuery) loadApprove(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(user.FieldApprovedBy)
	}
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ApproveColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := uq.ctx.Fields; len(fields) > 0 {
		...
		if uq.withAssigned != nil {
			_spec.Node.AddColumnOnce(user.FieldAssignedBy)
		}
		if uq.withApproved != nil {
			_spec.Node.AddColumnOnce(user.FieldApprovedBy)
		}
	}
